...
# 
# Priority:
# Priority allows a currently running job to be interrupted.
# For instance if you are doing a low priority scan and your movement thread
# wants to make sure it's not about to hit a wall
...
@contact = nil
Scanner.loop do
  priority = 1 # the lower the slower
  ...
  @contact = scan direction: direction, sweep: sweep, range: range, priority: priority
end
...
def check_for_walls(direction)
  ...
  !Scanner.scan direction: direction, sweep: 1, range: Motor.speed, priority: 10
end
